            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="row1 ">
                          <form action="{{ route('admin.subservices.create') }}" method="GET">
                            @csrf
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($subservices as $subservice)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.subservices.destroy', $subservice->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <td>
                                            <form action="{{ route('admin.subservices.edit', $subservice->id) }}" method="GET">
                                                @csrf
