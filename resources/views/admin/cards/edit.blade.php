                        ...
                        <div class="card-body">
                          <form enctype="multipart/form-data" action="{{ route('admin.cards.update', $card->id) }}" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="title[en]" value="{{ old('title', $card->title) }}" class="form-control @error('title') is-invalid @enderror" placeholder="headerSlide">
                              @error('title.*')
                            ...
                            <div class="form-group">
                              ...
                              <textarea name="content[en]" id="summernote">{!! old('content', $card->content) !!}</textarea>
                              @error('content.*')
                              <div class="alert alert-danger">
                                 {{$message}}
                              </div>
