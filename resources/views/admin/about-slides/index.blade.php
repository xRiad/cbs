                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($headerSlides as $headerSlide)
                                    <tr>
                                        <td>{{$headerSlide->id}}</td>
                                        <td>{{$headerSlide->title}}</td>
                                        <td>{{$headerSlide->content}}</td>
                                        <td>
                                            <form action="{{ route('admin.about-slides.destroy', $headerSlide->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <td>
                                            <form action="{{ route('admin.about-slides.edit', $headerSlide->id) }}" method="GET">
                                                @csrf
